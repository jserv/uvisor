...
#define UVISOR_TACL_SUBREGIONS(x)   ((((uint32_t) (x)) << UVISOR_TACL_SUBREGIONS_POS) & \
                                     UVISOR_TACL_SUBREGIONS_MASK)
 ...
 */
#define UVISOR_REGION_BITS(x) \
    (((x) <= 32UL) ? \
     5 : (((x) <= 64UL) ? 6 : (((x) <= 128UL) ? 7 : (((x) <= 256UL) ? \
     8 : (((x) <= 512UL) ? 9 : (((x) <= 1024UL) ? \
